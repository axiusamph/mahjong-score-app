...
st.markdown("오카 있을시 반환점 30000, 없을시 반환점 25000입니다. (오카란, 각자 반환점에서 일정 수준을 걷은 만큼 초기 점수(25000)를 받을 때, 각자에게 걷은 점수(20000)를 끝나고 모두 1등에게 주는 것입니다. 우마는 N/M 우마시 승점을 3등이 2등에게 N만큼, 4등이 1등에게 M만큼 줍니다.")
st.markdown("")
